# Great Learning (Olympus) — Course Content Download Manifest
...
| Tag | Meaning |
|---|---|
| MLS | Mentored Learning Session materials (live-session slides, datasets, notebooks) |
| Lecture Notes | Slides / notes PDFs tied to weekly lecture content |
| Lecture Notebooks | Jupyter notebooks and code files tied to weekly lecture content |
| Practice Exercise | Additional/optional case-study exercises and their solutions |
| Additional Material | Supplementary datasets, references, configs, and monographs |
| Project | Main course project files (templates, datasets, solutions, rubrics, support sessions) |
| Additional Project | Secondary/bonus project files (templates, datasets, solutions) |
| Program Info | General program/orientation documents (Program Overview course only) |

## Status legend

- ✅ Downloaded and confirmed (download icon reverted from spinner to static; verified as "Viewed" in the course)
- ⚠️ Inaccessible / locked (genuine lock icon on the section; account does not yet have access)
...
### Weeks 0–1: Introduction, Linear Regression

| Week/Section | File Name | Category | Type | Status |
|---|---|---|---|---|
| AI Application Case Study #3 | US_Airways.csv | Practice Exercise | CSV | ✅ |
| AI Application Case Study #3 | Session Notebook: Airline Customer Sentiment Analysis | Practice Exercise | Notebook | ✅ |
| Week 0: Introduction to Machine Learning | Lecture Slides - Introduction to Machine Learning | Lecture Notes | PDF | ✅ |
| Week 1: Linear Regression | Lecture Slides: Linear Regression | Lecture Notes | PDF | ✅ |
| MLS 1: Linear Regression | Session Presentation: Linear Regression | MLS | PDF | ✅ |
| MLS 1: Linear Regression | used_cars_data.csv | MLS | CSV | ✅ |
| MLS 1: Linear Regression | Session Notebook: Cars4U | MLS | Notebook | ✅ |
| Week 1: Reference Material | Summary Reading - Linear Regression | Additional Material | PDF | ✅ |
| Week 1: Practice Exercise | Practice Exercise 1: Linear Regression - Question Notebook | Practice Exercise | Notebook | ✅ |
| Week 1: Practice Exercise | boston.csv | Practice Exercise | CSV | ✅ |
| Week 1: Practice Exercise | Practice Exercise 1: Linear Regression - Solution Notebook | Practice Exercise | Notebook | ✅ |
| Week 1: Additional Case Study | anime_data.csv | Practice Exercise | CSV | ✅ |
| Week 1: Additional Case Study | Solution Notebook: Anime Rating Case Study | Practice Exercise | Notebook | ✅ |
| [OPTIONAL] Week 1: Additional Learning Material | Lecture Slides: Linear Regression Assumptions and Statistical Inference | Lecture Notes | PDF | ✅ |
| [OPTIONAL] Week 1: Additional Learning Material | Class Notes: Linear Regression Assumptions and Statistical Inference | Lecture Notes | PDF | ✅ |
| [OPTIONAL] Week 1: Additional Learning Material | Monograph - Linear Regression | Additional Material | PDF | ✅ |
| [OPTIONAL] Week 1: Additional Learning Material | WineData.csv | Lecture Notebooks | CSV | ✅ |
| [OPTIONAL] Week 1: Additional Learning Material | Interpretation of Linear Regression coefficients with log transform | Additional Material | PDF | ✅ |
| [OPTIONAL] Week 1: Additional Learning Material | Practice Exercise: Linear Regression Assumptions - Question Notebook | Practice Exercise | Notebook | ✅ |
| [OPTIONAL] Week 1: Additional Learning Material | Practice Exercise: Linear Regression Assumptions - Solution Notebook | Practice Exercise | Notebook | ✅ |

### Week 2: Decision Tree / Logistic Regression

| Week/Section | File Name | Category | Type | Status |
|---|---|---|---|---|
| Week 2: Decision Tree | Lecture Slides: Decision Trees | Lecture Notes | PDF | ✅ |
| MLS 2: Decision Tree | Session Presentation: Decision Tree | MLS | PDF | ✅ |
| MLS 2: Decision Tree | Machine Failure Prediction dataset | MLS | CSV | ✅ |
| MLS 2: Decision Tree | Session Notebook: Machine Failure Prediction | MLS | Notebook | ✅ |
| Week 2: Reference Material | Summary reading - Decision Tree building & pruning | Additional Material | PDF | ✅ |
| Week 2: Additional Case Study | Loan_Delinquent_Dataset.csv | Practice Exercise | CSV | ✅ |
| Week 2: Additional Case Study | Solution Notebook: Loan Delinquent Analysis | Practice Exercise | Notebook | ✅ |
| [OPTIONAL] Week 2: Additional Learning Material | Lecture Slides: Logistic Regression | Lecture Notes | PDF | ✅ |
| [OPTIONAL] Week 2: Additional Learning Material | Lecture Notes: Logistic Regression | Lecture Notes | PDF | ✅ |
| [OPTIONAL] Week 2: Additional Learning Material | who_data.csv | Practice Exercise | CSV | ✅ |
| [OPTIONAL] Week 2: Additional Learning Material | Solution Notebook: WHO Case Study | Practice Exercise | Notebook | ✅ |

### Week 3: Clustering

| Week/Section | File Name | Category | Type | Status |
|---|---|---|---|---|
| Week 3: Clustering | Lecture Slides: Clustering | Lecture Notes | PDF | ✅ |
| MLS 3: Clustering | Session Presentation: K-means Clustering | MLS | PDF | ✅ |
| MLS 3: Clustering | Credit Card Segmentation dataset | MLS | CSV | ✅ |
| MLS 3: Clustering | Session Notebook: AllLife Bank Customer Segmentation | MLS | Notebook | ✅ |
| Week 3: Additional Case Study | data_add_nik.csv | Practice Exercise | CSV | ✅ |
| Week 3: Additional Case Study | Solution Notebook: Product Segmentation | Practice Exercise | Notebook | ✅ |
| [OPTIONAL] Week 3: Additional Learning Material | Lecture Notes: Hierarchical Clustering | Lecture Notes | PDF | ✅ |
| [OPTIONAL] Week 3: Additional Learning Material | Lecture Slides: Dimensionality Reduction and PCA | Lecture Notes | PDF | ✅ |
| [OPTIONAL] Week 3: Additional Learning Material | Class Notes: Dimensionality Reduction and PCA | Lecture Notes | PDF | ✅ |
| [OPTIONAL] Week 3: Additional Learning Material | Solution Notebook: Product Segmentation Case Study | Practice Exercise | Notebook | ✅ |
| [OPTIONAL] Week 3: Additional Learning Material | data.csv (gene data) | Practice Exercise | CSV | ✅ |
| [OPTIONAL] Week 3: Additional Learning Material | labels.csv | Practice Exercise | CSV | ✅ |
| [OPTIONAL] Week 3: Additional Learning Material | Solution Notebook: Gene Data Case Study | Practice Exercise | Notebook | ✅ |
| [OPTIONAL] Week 3: Additional Learning Material | country_stats dataset | Practice Exercise | CSV | ✅ |
| [OPTIONAL] Week 3: Additional Learning Material | Solution Notebook: Tourism Services | Practice Exercise | Notebook | ✅ |
| [OPTIONAL] Week 3: Additional Learning Material | Monograph - Clustering | Additional Material | PDF | ✅ |
| [OPTIONAL] Week 3: Additional Learning Material | Monograph - PCA | Additional Material | PDF | ✅ |

### Projects (Personal Loan Campaign, Airbnb)

| Week/Section | File Name | Category | Type | Status |
|---|---|---|---|---|
| Project: Personal Loan Campaign | Loan_Modelling.csv | Project | CSV | ✅ |
| Project: Personal Loan Campaign | Template Notebook: Full-code Version | Project | Notebook | ✅ |
| Project: Personal Loan Campaign | Template Notebook: Low-code Version | Project | Notebook | ✅ |
| Project: Personal Loan Campaign | Presentation Template | Project | PPTX | ✅ |
| Project Support Session (Sep'25 & earlier) | Session Presentation: Support Session | Project | PDF | ✅ |
| Project Support Session (Oct'25 & later) | Session Presentation: Support Session | Project | PDF | ✅ |
| Project Solution: Personal Loan Campaign | Solution Presentation: Personal Loan Campaign | Project | PPTX/PDF | ✅ |
| Project Solution: Personal Loan Campaign | Solution Notebook: Personal Loan Campaign | Project | Notebook | ✅ |
| [ONLY FOR EVALUATORS] Project Detailed Rubric | Detailed Rubric: Personal Loan Campaign | Project | PDF | ✅ |
| Additional Project: Airbnb | Airbnb.csv | Project | CSV | ✅ |
| Additional Project: Airbnb | Template Notebook: Full-code Version | Project | Notebook | ✅ |
| Additional Project: Airbnb | Template Notebook: Low-code Version | Project | Notebook | ✅ |
| Additional Project Solution: Airbnb | Solution Presentation: Airbnb | Project | PPTX/PDF | ✅ |
| Additional Project Solution: Airbnb | Solution Notebook: Airbnb | Project | Notebook | ✅ |

**Course 4 status:** Complete — no locked/inaccessible items found.
...
### Week 1: Introduction to Model Deployment

| Week/Section | File Name | Category | Type | Status |
|---|---|---|---|---|
| Week 1: Intro to Model Deployment | Case_Study_Introduction_to_Model_Deployment.ipynb | Lecture Notebooks | Notebook | ✅ |
| Week 1: Intro to Model Deployment | bank_customer_churn.csv | Additional Material | CSV | ✅ |
| Week 1: Intro to Model Deployment | Introduction_to_GitHub_and_GitHub_Codespaces.pdf | Additional Material | PDF | ✅ |
| Week 1: Intro to Model Deployment | GitHub_Account_and_Personal_Access_Token_Guide.pdf | Additional Material | PDF | ✅ |
| Week 1: Intro to Model Deployment | Guided_Hands_on_Streamlit_GitHub_Codespaces.ipynb | Lecture Notebooks | Notebook | ✅ |
| Week 1: Intro to Model Deployment | customer_churn_data.csv | Additional Material | CSV | ✅ |
| Week 1: Intro to Model Deployment | Deploying_Streamlit_App_on_GitHub_Codespace.pdf | Additional Material | PDF | ✅ |
| Week 1: Intro to Model Deployment | space_token.png | Additional Material | PNG | ✅ |
| Week 1: Intro to Model Deployment | Lecture Slides - Introduction to Model Deployment.pdf | Lecture Notes | PDF | ✅ |
| Week 1: MLS | Session Presentation: Introduction to Model Deployment.pdf | MLS | PDF | ✅ |
| Week 1: MLS | Airbnb.csv | MLS | CSV | ✅ |
| Week 1: MLS | Session Notebook: Airbnb | MLS | Notebook | ✅ |
| Week 1: MLS | Introduction to GitHub and GitHub Codespaces.pdf | MLS | PDF | ✅ (dup of Week 1 file, downloaded again as separate entry) |
| Week 1: MLS | Creating GitHub Account and Gen...pdf | MLS | PDF | ✅ (dup) |
| Week 1: MLS | Deploying Streamlit App on GitHub Codespace.pdf | MLS | PDF | ✅ (dup) |

### Week 2: Containerization

| Week/Section | File Name | Category | Type | Status |
|---|---|---|---|---|
| Week 2: Containerization | Case Study - REST API and Containerization | Lecture Notebooks | Notebook | ✅ |
| Week 2: Containerization | bank_customer_churn.csv | Additional Material | CSV | ✅ (dup, skipped re-download) |
| Week 2: Containerization | Introduction_to_GitHub_and_GitHub_Codespaces.pdf | Additional Material | PDF | ✅ (dup, skipped re-download) |
| Week 2: Containerization | GitHub_Account_and_Personal_Access_Token_Guide.pdf | Additional Material | PDF | ✅ (dup, skipped re-download) |
| Week 2: Containerization | Guided_Hands_On_Containerized_Deployment.ipynb | Lecture Notebooks | Notebook | ✅ |
| Week 2: Containerization | Batch-data-telecom.csv | Additional Material | CSV | ✅ |
| Week 2: Containerization | churn_prediction_model_v1_0.joblib | Additional Material | JOBLIB | ✅ |
| Week 2: Containerization | Deploying_Frontend_and_Backend_on_GitHub_Codespace.pdf | Additional Material | PDF | ✅ |
| Week 2: Containerization | Guided_Hands_On_REST_API_and_Containerization_Notebook.ipynb | Lecture Notebooks | Notebook | ✅ |
| Week 2: Containerization | Batch-data-telecom.csv | Additional Material | CSV | ✅ (dup, skipped re-download) |
| Week 2: Containerization | churn_prediction_model_v1_0.joblib | Additional Material | JOBLIB | ✅ (dup, skipped re-download) |
| Week 2: Containerization | Lecture Slides - Containerization.pdf | Lecture Notes | PDF | ✅ |
| Week 2: MLS | Session Presentation: Containerization.pdf | MLS | PDF | ✅ |
| Week 2: MLS | airbnb_rental_batch_data.csv | MLS | CSV | ✅ |
| Week 2: MLS | rental_price_prediction_model_v1_0.joblib | MLS | JOBLIB | ✅ |
| Week 2: MLS | Session Notebook: Pricebnb Containerized Deployment | MLS | Notebook | ✅ |
| Week 2: MLS | Introduction to GitHub and GitHub Codespaces.pdf | MLS | PDF | ✅ (dup, downloaded again as separate entry) |
| Week 2: MLS | Creating GitHub Account and Gen...pdf | MLS | PDF | ✅ (dup) |
| Week 2: MLS | Deploying Frontend and Backend on GitHub Codespace.pdf | MLS | PDF | ✅ (dup) |

### Projects (SuperKart, ExtraaLearn)

| Week/Section | File Name | Category | Type | Status |
|---|---|---|---|---|
| Project: SuperKart | SuperKart.csv | Project | CSV | ✅ |
| Project: SuperKart | Batch_Data_SuperKart.csv | Project | CSV | ✅ |
| Project: SuperKart | Template Notebook: Full-Code Version | Project | Notebook | ✅ |
| Project: SuperKart | Template Notebook: Low-Code Version | Project | Notebook | ✅ |
| Project: SuperKart | Presentation Template.pptx | Project | PPTX | ✅ |
| Project Solution: SuperKart | Solution Notebook: SuperKart | Project | Notebook | ✅ |
| Project Solution: SuperKart | Solution Presentation: SuperKart.pdf | Project | PDF | ✅ |
| Project-7 Support Session: SuperKart | Session Presentation: Project Support.pdf | MLS | PDF | ✅ |
| [ONLY FOR EVALUATORS] Project Detailed Rubric: SuperKart | Detailed Rubric: SuperKart.pdf | Project | PDF | ✅ (not locked — downloaded per methodology) |
| Additional Project: ExtraaLearn | ExtraaLearn.csv | Project | CSV | ✅ |
| Additional Project: ExtraaLearn | Template Notebook: Full-code Version | Project | Notebook | ✅ |
| Additional Project: ExtraaLearn | Template Notebook: Low-code Version | Project | Notebook | ✅ |
| Additional Project Solution: ExtraaLearn | Solution Notebook: ExtraaLearn | Project | Notebook | ✅ |
| [ONLY FOR EVALUATORS] Additional Project Detailed Rubric: ExtraaLearn | Detailed Rubric: ExtraaLearn.pdf | Project | PDF | ✅ (not locked — downloaded per methodology) |

**Course 8 status:** Complete — no locked/inaccessible items found. ~33 unique files downloaded (several duplicate files across sections identified and skipped on re-appearance).
...
| Week/Section | File Name | Category | Type | Status |
|---|---|---|---|---|
| Week 1 - Introduction to NLP | Sentiment_Analysis_Hands_on.ipynb | Lecture Notebooks | Notebook | ✅ |
| Week 1 - Introduction to NLP | movie_reviews.csv | Additional Material | CSV | ✅ |
| Week 1 - Introduction to NLP | Lecture Notes - Intro to NLP.pdf | Lecture Notes | PDF | ✅ |
| Week 1 - Introduction to NLP | Lecture Slides - Text Cleaning and Vectorization.pdf | Lecture Notes | PDF | ✅ |
| Week 1 - Introduction to NLP | Lecture Slides - Sentiment Analysis.pdf | Lecture Notes | PDF | ✅ |
| Week 1: Reference Material (4 Resources) | — | — | — | ⚠️ |
| MLS 1: Introduction to NLP (5 Resources) | — | — | — | ⚠️ |
| Week 2 - Word Embeddings (7 Resources) | — | — | — | ⚠️ |
| Week 2: Reference Material (3 Resources) | — | — | — | ⚠️ |
| Week 2: Additional Case Study (4 Resources) | — | — | — | ⚠️ |
| MLS 2: Word Embeddings (6 Resources) | — | — | — | ⚠️ |
| Week 3 - Attention Mechanism and Transformers (5 Resources) | — | — | — | ⚠️ |
| Week 3: Reference Material (5 Resources) | — | — | — | ⚠️ |
| MLS 3: Attention Mechanism and Transformers (7 Resources) | — | — | — | ⚠️ |
| Week 4 - LLMs and Prompt Engineering (5 Resources) | — | — | — | ⚠️ |
| Week 3: Additional Case Study (3 Resources) | — | — | — | ⚠️ |
| Week 4: Reference Material (3 Resources) | — | — | — | ⚠️ |
| MLS 4: LLMs and Prompt Engineering (7 Resources) | — | — | — | ⚠️ |
| Project 7: Detailed Rubric (1 Resource) | — | — | — | ⚠️ |
| Project 7: Stock Market News Sentiment Analysis (6 Resources) | — | — | — | ⚠️ |
| MLS 5: Project Debrief (3 Resources) | — | — | — | ⚠️ |
| [Oct'24+ cohorts] Course Overview (3 Resources) | — | — | — | ⚠️ |
| [Oct'24+ cohorts] Week 0 - Introduction to NLP (5 Resources) | — | — | — | ⚠️ |
| [Oct'24+ cohorts] Week 1 - Word Embeddings (7 Resources) | — | — | — | ⚠️ |
...
| Category | File Count (downloaded) |
|---|---|
| MLS | 55 |
| Lecture Notes | 62 |
| Lecture Notebooks | 35 |
| Practice Exercise | 35 |
| Additional Material | 48 |
| Project | 71 |
| Additional Project | 4 |
| Program Info | 3 |
| **Total downloaded** | **≈ 313** |

# Locked / inaccessible sections summary

| Course | Locked Sections | Approx. Locked Resources |
|---|---|---|
| 9: Introduction to Natural Language Processing | ~19 | ~100+ |
| 10: Statistical Learning | 10 | 52 |
| 11: Introduction to Computer Vision | 17 | 68 |
| 12: Introduction to Neural Networks | 13 | 56 |
| 13: Program Overview | 3 | ~8 |

Courses 1–8 had no locked content; all downloadable material in those courses was accessible and downloaded.

---

**A note on file location:** every file listed above with a ✅ was downloaded through your browser and landed in your computer's Chrome **Downloads** folder — none of the files themselves are stored in this session. This manifest is only a record of what was downloaded, its category, and its status; use it as an index if you need to locate or re-organize the files afterward.
